...
export const config = {
  light: vars({
    ...
    /* Tertiary */
    '--color-tertiary-50': '187 246 195',
    '--color-tertiary-100': '156 238 167',
    '--color-tertiary-200': '126 228 140',
    '--color-tertiary-300': '99 215 115',
    '--color-tertiary-400': '75 200 91',
    '--color-tertiary-500': '56 181 73',
    '--color-tertiary-600': '56 155 69',
    '--color-tertiary-700': '55 132 66',
    '--color-tertiary-800': '53 111 61',
    '--color-tertiary-900': '50 91 55',
    '--color-tertiary-950': '45 72 49',
